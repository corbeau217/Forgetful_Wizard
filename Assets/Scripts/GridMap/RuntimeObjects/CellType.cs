...
static class CellTypeUtils {

    public const int CELL_SHEET_ROWS = 8;
    public const int CELL_SHEET_COLS = 8;
    public const int CELL_SHEET_COUNT = 64;

    // supplying the index of the type
    public static int GetIndex(this CellType input){
        // mod 64 to handle if it's part of the standard set or secondary detail set
        return (int)input%CELL_SHEET_COUNT;
    }
    public static bool IsBaseTile(this CellType input){
        return (int)input < CELL_SHEET_COUNT;
    }
    public static bool IsDetailTile(this CellType input){
        return (int)input >= CELL_SHEET_COUNT && (int)input < 2*CELL_SHEET_COUNT;
    }
    public static bool IsRoomTile(this CellType input){
        return (int)input >= 2*CELL_SHEET_COUNT;
    }

    // get the pixel information by type
    public static Color[] GetPixelsFromSpritesheet(this CellType input, Texture2DArray arrayToSearch){
