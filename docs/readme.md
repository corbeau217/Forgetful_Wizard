...
### Milestone 001 - project research
- [x] simple scene
    ...
    - [x] dash
    - [x] blink
### Milestone 002 - simple map creation
...
### Milestone 003 - tiled map creation
- [x] tile mapping changes
...
- [ ] using texture to determine tile placement rules
- [ ] `TileType` for determining tile similarity
